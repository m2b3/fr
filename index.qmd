...
[![](images/contactsm.png){fig-alt="Membres du laboratoire" fig-align=left}](members.qmd)

<!-- to make a contact sheet, set boundaries in irfanview thumbnails -->

**Actualités**

**Juin 2023** - Alexandru, Bradley, Yavuz, Lilia et Youzhi rejoignent le laboratoire en tant que stagiaires d'été. Alexandru et Lilia suivront ensuite les cours NSCI 410 et PSYC 494 respectivement avec nous pendant deux semestres. 
