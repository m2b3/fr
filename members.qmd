...
[![Sizhuo Wang](images/sizhuo.png){fig-alt="Photo de Sizhuo"}](#sizhuo)

[![Bradley Austin-Keiller](images/bradleysm.png){fig-alt="Photo de Bradley"}](#bradley)

[![Lilie Jeanneaux](images/marty2.png){fig-alt="Photo de Lilie"}](#lilie)

[![Louis Martinez](images/LouisSmall.jpg){fig-alt="Photo de Louis"}](#Louis)

[![Jacky Chen](images/jackysm.png){fig-alt="Photo de Jacky"}](#jacky)

[![Yagya Joshi](images/yagyasm.png){fig-alt="Photo de Yagya"}](#yagya)
...
::: column-margin
![](images/sizhuo.png){fig-alt="Photo de Sizhuo" width="200"}
:::

* Étudiant à la Maîtrise, Programme Intégré en Neurosciences (PIN), McGill.
* Étudiant à la Maîtrise en Ingénierie, Génie Biomédical, Université des Sciences et Technologies Électroniques de Chine, Chengdu, Chine.
* B.Eng. en Ingénierie, Génie Biomédical, Université des Technologies de Taiyuan, Taiyuan, Chine.
* Mes recherches portent sur le développement de modèles algorithmiques d'encodage et de décodage pour explorer les mécanismes complexes du cerveau, en particulier dans le domaine de la perception visuelle.
...
::: column-margin
![](images/bradleysm.png){fig-alt="Photo de Bradley" width="200"}
:::
...
* Étudiante au Baccalauréat en Génie Civil, Université McGill
* CPGE PCSI (Classe Préparatoire aux Grandes Écoles en physique et chimie), Lycée Louis-le-Grand, Paris, France
* Mon objectif est de poursuivre mes études dans le génie environnemental. Dans mon temps libre, je suis également passionnée par la musique.
* [Courriel](mailto:lilie.jeanneaux@mail.mcgill.ca)
...
::: column-margin
![](images/LouisSmall.jpg){fig-alt="Photo de Louis" width="200"}
:::
...
* [Courriel](mailto:louis.martinez@telecom-paris.fr), [Github](https://github.com/lmartinez2001/),[LinkedIn](https://www.linkedin.com/in/louis-martinez-5586b71b7/)
...
* Étudiante en Baccalauréat de psychologie avec une double mineure en sciences comportementales et en sciences des arts, à l'Université McGill.
* Je suis passionnée de piano et je m'intéresse aux interactions entre les processus cognitifs, l'expression musicale et les variations de l'attention. Mes recherches explorent les liens entre la psychologie, la musique et les sciences cognitives.
...
*   Étudiants de 1er Cycle Observateurs - Caden Welch, Max Tweedale, Elisa Niunin, Yavuz Shahzad, Divi Maheshwari
