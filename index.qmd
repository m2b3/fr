...
**Septembre 2026** – CanVIT a été accepté pour une présentation par affiche à NeurIPS 2026. Félicitations à Yohai et Sabrina ! 🎉

**Septembre 2026** – Le manuscrit de Kasia et Yohai, intitulé « Human-like meaning maps from single-prompt VLM ratings of local scene meaning », est disponible en prépublication sur bioRxiv.

**Juillet 2026** — Notre manuscrit intitulé « Effect of an auditory static distractor on the perception of an auditory moving target », un travail mené par Noa Kemp en collaboration avec Catherine Guastavino, paraîtra prochainement dans le Journal of the Acoustical Society of America, à l’issue d’un processus d’évaluation fluide et constructif. Heureux d’avoir à nouveau un article dans JASA après une longue pause :)

**Juin 2026** – Fatma Ozlem obtient une bourse Études au Canada pour effectuer un séjour au laboratoire en 2026-2027, en provenance de Sağlık Bilimleri Üniversitesi à Istanbul.

**Mai 2026** – Yohai reçoit le prix UNIQUE-CerebrUM de la meilleure présentation au Symposium étudiant UNIQUE. Félicitations Yohai ! 🎉

**Avril 2026** - Yohai obtient une bourse de doctorat en recherche du FRQNT, ainsi qu’une bourse de déplacement UNIQUE pour faciliter son voyage à New York au symposium AI in Biology du CSHL. Félicitations Yohai !! 🎉

**Avril 2026** — Les membres du laboratoire feront partie des équipes de mentorat pour 5 projets open source du Google Summer of Code, via [INCF](https://www.incf.org/), cet été :

- iEEG — un logiciel d’analyse de données EEG intracrâniennes, en collaboration avec le CHUM
- [SciCommons](https://alphatest.scicommons.org) — une plateforme ouverte pour la discussion et l’évaluation scientifiques
- BreathState — une application mobile pour le suivi de la respiration, du rythme cardiaque et de leur lien avec la santé mentale et la performance
- ActiveVision — un outil de modélisation de la vision active
- GestureCap — un système sans marqueurs pour l’expression musicale pilotée par gestes, et autres applications

**Avril 2026** - Yohai reçoit une bourse CGRS-D du CRNSG. Félicitations Yohai !! 🎉

**Avril 2026** - Alex Zhao reçoit une bourse CGSM des IRSC et Yohai obtient une bourse de doctorat UNIQUE. Félicitations à Alex et à Yohai !! 🎉

**Mars 2026** - [Le modèle CanVIT](https://arxiv.org/abs/2603.22570) de Yohai est maintenant disponible en prépublication sur arXiv !! 🎉📄

**Mars 2026** – ["Correction of saccadic decisions during active visual search in the monkey"](https://jov.arvojournals.org/article.aspx?articleid=2811630) publié dans le Journal of Vision après un processus d’évaluation fluide, rapide et transparent. 📄
...
**Avril 2025** - Nouveau préprint méthodologique sur les enregistrements par microélectrodes dans l'insula humaine, issu de la collaboration en cours avec l’équipe du Dr Dang Nguyen au CHUM. [Preprints.org](https://www.preprints.org/manuscript/202504.1279/v1) 📄
...
**Mars 2025** - Nouvelle prépublication en ligne sur la variabilité des potentiels de champ local, issue d’une belle collaboration avec Mohsen Parto-Dezfouli et le groupe élargi de Pascal Fries. [bioRxiv](https://www.biorxiv.org/content/10.1101/2025.03.27.645661v1) 📄
...
**Mai 2024** - Welcoming Jacky and Alex to the lab as undergraduate research trainees. They will be with us for several months to a year. 💐
